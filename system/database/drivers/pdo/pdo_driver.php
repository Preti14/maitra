...
class CI_DB_pdo_driver extends CI_DB {
    ...
    {
//        if (is_numeric(stripos($sql, 'SELECT'))) //CI ORIGINAL
        //REASON: http://stackoverflow.com/a/19730778/1593365
        if (preg_match('/^\s*"?(SELECT)\s+/i', $sql)) //SALZER - vijayang@salzertechnologies.com
        {
