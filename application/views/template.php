...
<link href="<?=base_url();?>css/theme-print.css" rel='stylesheet' media="print" type='text/css' />
<style>
@media print
        {
            body { 
	...
	if(template_id != ''){
		...
		$.getJSON("<?=base_url();?>?c=search&m=fetch_all_temp&tid="+template_id+"",function(data){
				$.each(data,function(index,item) 
					{
						$("#m_status").find('option:selected').removeAttr("selected");
						...
						$("#with_comm option[value='"+item.with_comm+"']").attr("selected","selected");
                ...
                <div class="nav-canvas" style="margin-top:10px">
                    ...
                    <div id="accordion" >
                        ...
                        if ($session['login_type'] == 1 ||
                            ...
                            ?>
                     <div class="panel-heading ui-accordion-header ui-state-default ui-accordion-icons ui-corner-all main-accordion">
                        <h4 class="panel-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Mail Tracking System</a>
                        </h4>
                      </div>
					<div id="collapse1" class="panel-collapse collapse in collapsecustom ">
					   ...
					   if(isset($_GET['subdivision_id'])){ 
                        ...
                        <?php if ($session['login_type'] == 1) {//Admin only?>
                            ...
                            <div id="collapse3" class="panel-collapse collapse ">
                                <ul class="nav nav-pills nav-stacked main-menu list-group-item">
                                        <?php /*?><li <?= ($_GET['m'] == "plugins") ? 'class="active"' : ''; ?>>
                                            <a href="<?= base_url(); ?>?c=home&m=plugins"><i class="glyphicon glyphicon-book"></i> Plugin List</a></li><?php */?>
                                        ...
                                        <li>
                                            <a href="#" id="backup_download"  onClick="db_download();"><i class="glyphicon glyphicon-download-alt"></i> Backup DB</a></li>
...
{
	$("#backup_download").confirm({
		text: "Are you sure that you really want to download the database ?",
